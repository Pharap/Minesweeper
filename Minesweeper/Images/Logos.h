...
namespace Images
{
	static constexpr uint8_t TitleWidth = 128;
	static constexpr uint8_t TitleHeight = 25;
	...
	static constexpr uint8_t PharapLogoWidth = 48;
	static constexpr uint8_t PharapLogoHeight = 48;
	...
	static constexpr uint8_t ArrowWidth = 8;
	static constexpr uint8_t ArrowHeight = 8;
