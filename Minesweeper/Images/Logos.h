...
namespace Images
{
	constexpr static uint8_t TitleWidth = 128;
	constexpr static uint8_t TitleHeight = 25;
	...
	constexpr static uint8_t PharapLogoWidth = 48;
	constexpr static uint8_t PharapLogoHeight = 48;
	...
	constexpr static uint8_t ArrowWidth = 8;
	constexpr static uint8_t ArrowHeight = 8;
