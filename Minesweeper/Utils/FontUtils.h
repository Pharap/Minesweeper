...
constexpr uint8_t FontCharWidth = 5;
constexpr uint8_t FontCharHeight = 7;
constexpr uint8_t FontSpaceWidth = 1;
constexpr uint8_t FontSpaceHeight = 1;
constexpr uint8_t FontLineHeight = FontCharHeight + FontSpaceHeight;
